...
import com.messi.learnenglish.util.GytUtil;
...
import com.messi.learnenglish.views.ProportionalImageView;
...
public class StudyFragment extends Fragment implements OnClickListener{
	...
	private FrameLayout symbol_study_cover,story_layout,jokes_layout,study_listening_layout;
