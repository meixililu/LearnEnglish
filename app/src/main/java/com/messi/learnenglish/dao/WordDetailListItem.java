...
/**
 * Entity mapped to table "WORD_DETAIL_LIST_ITEM".
 */
public class WordDetailListItem {
    ...
    public WordDetailListItem(Long id) {
        this.id = id;
    }

    public WordDetailListItem(Long id, String item_id, String class_id, Integer course, String class_title, String desc, String name, String sound, String symbol, String examples, String mp3_sdpath, String img_url, String new_words, String is_study, String backup1, String backup2, String backup3) {
        this.id = id;
