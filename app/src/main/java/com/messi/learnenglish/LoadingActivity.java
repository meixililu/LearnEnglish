...
import com.messi.learnenglish.http.OkHttpUrlLoader;
...
import com.messi.learnenglish.util.ShortCut;
...
public class LoadingActivity extends Activity implements OnClickListener{
	...
	private void toNextPage(){
		try {
			Intent intent = new Intent(LoadingActivity.this, ReadingJuheActivity.class);
