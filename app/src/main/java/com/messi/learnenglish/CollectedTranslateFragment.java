...
import com.messi.learnenglish.adapter.ResultListHeaderAdapter;
...
//		});
		...
		mAdapter = new ResultListHeaderAdapter(getActivity(), mInflater, beans, 
				mSpeechSynthesizer, mSharedPreferences, bundle, false);
